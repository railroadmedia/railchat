...
class AccessControllerTest extends RailchatTestCase
{
    ...
    public function test_delete_user_messages_validation()
    {
        ...
        $response = $this->call('POST', '/delete-user-messages', []);
    ...
    public function test_delete_user_messages_stream_not_found_error()
    {
        $this->permissionServiceMock->method('can')->willReturn(true);
    ...
    public function test_delete_user_messages_stream_error()
    {
        $this->permissionServiceMock->method('can')->willReturn(true);
    ...
    public function test_delete_user_messages_error()
    {
        $this->permissionServiceMock->method('can')->willReturn(true);
    ...
    public function test_delete_user_messages()
    {
        $this->permissionServiceMock->method('can')->willReturn(true);
